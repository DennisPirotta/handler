@extends('layouts.app')
@section('content')
    <script class="animation_style" src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
    <script class="animation_style" src="https://unpkg.com/@lottiefiles/lottie-interactivity@latest/dist/lottie-interactivity.min.js"></script>
    ...
    <script class="animation_style">
        $(() => {
            let animation = lottie.loadAnimation({
                ...
                autoplay: true,
                name: 'wallet',
                path: 'https://assets6.lottiefiles.com/packages/lf20_wwldbpbx.json' // the path to the animation json
            });
